...
import crawler.domain.Ou; 
 
public class WebScrapper { 
	public static void main(String args[]) throws Exception {
		
		try {
		int i =  1211000; //2016년 1월1일
		int errorIndex = 0; 
		String month = "01";
		while(true){
			...
			try {
				...
				String url = "http://todayhumor.com/?freeboard_"+i;
				...
				Ou ou = new Ou();
				Board board = ou.readLogData(doc);
				board.setUrl(url); 
				...
				File targetFile = new File("D:\\SNS_DATA\\ou_output_"+month+".txt");
