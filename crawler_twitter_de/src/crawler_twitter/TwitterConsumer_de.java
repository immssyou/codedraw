            		   	...
            		   	if(lang.equals("de")){
        		   			if(filterWord(text)){ //필터링
        		   				if(!queue.contains(text)){//중복내용 제거
        		   					...
        		   					File targetFile = new File(File.separator+"home"+File.separator+"big"+File.separator+"twitter_data"+File.separator+"twitter_german_output_"+twit.getRegistDate()+".txt");
